...
class QuestionsViewModel : ViewModel() {
    ...
    private fun getQuestions() {
        StackOverflowService.api.getQuestions(page)
            .enqueue(object : retrofit2.Callback<ResponseWrapper<Question>> {
                override fun onResponse(call: Call<ResponseWrapper<Question>>, response: Response<ResponseWrapper<Question>>) {
